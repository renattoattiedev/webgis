...
// Presenter específico para o retorno detalhado por matrícula
export class SicatImovelMatriculaDetalhadaPresenter {
  static toHTTP(imovelDetalhado: SicatImovelMatriculaDetalhada) {
    return {
